...
- ░█▀█░█▄█░█▀▀░▀▀█░█░█░█░█░█▀▀░█▄█░█░█
- ░▀░▀░▀░▀░▀▀▀░▀▀▀░▀▀▀░▀░▀░▀▀▀░▀░▀░▀░▀
- Copyleft © 2022-2023, Yoru project
...
-- capitalize first letter of a string and return it
function _string.capitalize(msg)
...
function _string.repeat_string_until(str, len)
  local ret = ""
  while #ret < len do
    ret = ret .. str
  end
